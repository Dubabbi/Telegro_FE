                ...
                {activeTab === 'privacy' && (
                    <S.Section>
                        <S.Text>
                            <h1>개인정보처리방침</h1>
                            <hr />
                            <p>서연전자(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.</p>
                            ...
                            <p>회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정 이용 방지, 만 14세 미만 아동의 개인정보처리 시 법정대리인의 동의 여부 확인, 각종 고지․통지, 고충 처리 등을 목적으로 개인정보를 처리합니다.</p>
                            ...
                            <h4>1. 홈페이지 회원 가입 및 관리 : 사업자/단체 홈페이지 탈퇴 시까지</h4>
                            <p>다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료 </p>
                            <p>(1) 관계 법령 위반에 따른 수사, 조사 등이 진행 중인 경우에는 해당 수사, 조사 종료 시까지</p>
                            <p>(2) 홈페이지 이용에 따른 채권 및 채무관계 잔존 시에는 해당 채권, 채무 관계 정산 시까지</p>
                            <h4>2. 재화 또는 서비스 제공 : 재화․서비스 공급완료 및 요금결제․정산 완료 시까지</h4>
                            ...
                            <li>위탁받는 자 (수탁자) : 나이스페이먼츠 PG</li>
                            <li>위탁하는 업무의 내용 : 결제 및 에스크로 업무</li>
                            <li>위탁받는 자 (수탁자) : 로젠 택배</li>
                            ...
                            <h2>제5조(이용자 및 법정대리인의 권리와 그 행사 방법)</h2>
                            <p>① 정보주체는 회사에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.</p>
                            <h4>1. 개인정보 열람 요구</h4>
                            <h4>2. 오류 등이 있을 경우 정정 </h4>
                            <h4>3. 삭제요구</h4>
                            <h4>4. 처리정지 요구</h4>
                            ...
                            <h4>1. 홈페이지 회원 가입 및 관리</h4>
                            <p>필수항목 : 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 이메일주소</p>
                            <p>선택항목 : 회사명, 회사 소재지, 회사 업태, 사업자 번호</p>
                            <h4>2. 재화 또는 서비스 제공</h4>
                            ...
                            <h4>1. 관리적 조치 : 내부관리계획 수립 및 시행, 정기적 직원 교육 등</h4>
                            <h4>2. 기술적 조치 : 개인정보처리시스템 등의 접근 권한 관리, 접근통제시스템 설치, 고유 식별정보 등의 암호화, 보안프로그램 설치</h4>
                            <h4>3. 물리적 조치 : 전산실, 자료보관실 등의 접근통제</h4>
                            ...
                            <p>이 개인정보 처리방침은 2024.11.11부터 적용됩니다.</p>
                        </S.Text>
                    </S.Section>
                )}
                {activeTab === 'terms' && (
                    <S.Section>
                        <S.Text>
                            ...
                            <hr />
                            <h2>제1조 목적</h2>
                            <p>본 이용약관은 “Telegro”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.</p>
                            <h2>제2조 용어의 정의</h2>
                            ...
                            <p>② 단, 사이트는 다음 경우에 대하여 사전 공지나 예고 없이 서비스를 일시적 혹은 영구적으로 중단할 수 있습니다.</p>
                                ...
                                <li>서비스 이용의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 경우 ③ 전항에 의한 서비스 중단의 경우 사이트는 사전에 공지사항 등을 통하여 회원에게 통지합니다. 단, 사이트가 통제할 수 없는 사유로 발생한 서비스의 중단에 대하여 사전공지가 불가능한 경우에는 사후공지로 대신합니다.</li>
                            ...
                            <h2>제12조 게시물의 관리</h2>
                            <p>① 사이트의 게시물과 자료의 관리 및 운영의 책임은 운영자에게 있습니다. 운영자는 항상 불량 게시물 및 자료에 대하여 모니터링을 하여야 하며, 불량 게시물 및 자료를 발견하거나 신고를 받으면 해당 게시물 및 자료를 삭제하고 이를 등록한 회원에게 주의를 주어야 합니다. 한편, 이용회원이 올린 게시물에 대해서는 게시자 본인에게 책임이 있으니 회원 스스로 본 이용약관에서 위배되는 게시물은 게재해서는 안 됩니다. </p>
                            <p>② 정보통신윤리위원회 등 공공기관의 시정요구가 있는 경우 운영자는 회원의 사전동의 없이 게시물을 삭제하거나 이동 할 수 있습니다. </p>
                            ...
                            <li>공공질서 및 미풍양속에 위반되는 내용을 유포하거나 링크 시키는 경우</li>
                                ...
                                <li>기타 관계 법령에 위배된다고 판단되는 경우 ④ 사이트 및 운영자는 게시물 등에 대하여 제3자로부터 명예훼손, 지적재산권 등의 권리 침해를 이유로 게시중단 요청을 받은 경우 이를 임시로 게시 중단(전송중단)할 수 있으며, 게시중단 요청자와 게시물 등록자 간에 소송, 합의 기타 이에 준하는 관련 기관의 결정 등이 이루어져 사이트에 접수된 경우 이에 따릅니다.</li>
                                <h2>제13조 게시물의 보관</h2>
